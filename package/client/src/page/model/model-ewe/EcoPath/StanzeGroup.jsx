...
const StanzeColumns = [
  ...
  },
  {
    ...
    render: (_, item) => (
      <>
        {item.LeadingCB === item.LifeStage ? (
          <Tag color={'green'} key={item.LeadingCB}>
            {'YES'}
          </Tag>
        ) : (
          <></>
...
export default function StanzeGroupJS() {
  useEffect(() => {
    let myChart = echarts.getInstanceByDom(
      document.getElementById('StanzePlot'),
  ...
  return (
    <div style={{ height: '80%', width: '100%' }}>
      ...
      <div id="StanzePlot" style={{ height: '70%' }}></div>
