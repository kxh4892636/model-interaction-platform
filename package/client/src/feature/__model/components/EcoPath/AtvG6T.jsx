...
import { Lindman_spine,FromEvery } from '../../store';
...
export default function AtvG6T() {
  ...
  return (
    <div id='main' style={{height:"91%"}}>
        ...
        >
          {/* scroll={{ x: 400,y:400}} height="40%" */}
        <Table dataSource={FromEveryData} size='small' bordered='true' scroll={{ x: 500, y: 380 }}>
          ...
          <ColumnGroup title="Import">
            ...
            <Column title="From Detritus" dataIndex="Import_D" key="From Detritus" />
          ...
          <ColumnGroup title="Consumption by predators">
            ...
            <Column title="From Detritus" dataIndex="CP_D" key="From Detritus" />
          ...
          <ColumnGroup title="Export">
            ...
            <Column title="From Detritus" dataIndex="Export_D" key="From Detritus" />
          ...
          <ColumnGroup title="Flow to Detritus">
            ...
            <Column title="From Detritus" dataIndex="FD_D" key="From Detritus" />
          ...
          <ColumnGroup title="Resporation">
            ...
            <Column title="From Detritus" dataIndex="Respiration_D" key="From Detritus" />
          ...
          <ColumnGroup title="Throughput">
            ...
            <Column title="From Detritus" dataIndex="Throughput_D" key="From Detritus" />
