...
import { eweFile,UploadFlag,TimeSelect,TimeSeriesData,TimeSeriesPlot,TimeYearData,TimeSelected } from '../../../store/eweStore'
...
const MYupload = (props) => {
  ...
  return(
      <Upload {...Uploadprops}>
          <Button icon={<UploadOutlined />} disabled={UPflag}>上传功能函数文件</Button>
      </Upload>
  );
}
