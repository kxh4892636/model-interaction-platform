...
import { EcoSimGroup_Plot,EcoSimGroup_PlotColor,EcoSimGroup_PlotColorFleet,EcoSimGroup_PlotColorPred,EcoSimGroup_PlotColorPrey } from '../../../store/eweStore'
  ...
  return (
    <div style={{display:"flex",height:"88%"}}>
        ...
        <div style={{height:"100%",width:"20%"}}>
            <div style={{height:"45%"}}>
                <div style={{height:"20px",background:"#778899",color:"white"}}>Group</div>
                <div style={{height:"94%",overflow:'auto',borderStyle:"solid",borderWidth:"1px",borderBlockEnd:"none"}}>
            ...
            <div style={{height:"20%"}}>
                <div style={{height:"20px",background:"#778899",color:"white"}}>Predatorsranked</div>
                <div style={{height:"86%",overflow:'auto',borderStyle:"solid",borderWidth:"1px",borderBlockEnd:"none"}}>
                    <ul style={{paddingLeft:10,marginTop:2}}>
                        {Group_PlotPred}
                    </ul>
                </div>
            </div>
            <div style={{height:"20%"}}>
                <div style={{height:"20px",background:"#778899",color:"white"}}>Preyranked</div>
                <div style={{height:"86%",overflow:'auto',borderStyle:"solid",borderWidth:"1px",borderBlockEnd:"none"}}>
                    <ul style={{paddingLeft:10,marginTop:2}}>
                        {Group_PlotPrey}
                    </ul>
            ...
            <div style={{height:"15%"}}>
               <div style={{height:"20px",background:"#778899",color:"white"}}>Fleets</div>
                <div style={{height:"95%",overflow:'auto',borderStyle:"solid",borderWidth:"1px"}}>
                <ul style={{paddingLeft:10,marginTop:2}}>
                        {Group_PlotFleet}
                    </ul>
                </div>
