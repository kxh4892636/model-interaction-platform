...
import { MixedTrophicData,FlowDiagram } from '../../../store/eweStore';
export default function MixedTrophic() {
  ...
  return (
      <div style={{ textAlign: 'center' }}>
        <div style={{ marginBottom: '30px', fontWeight: 'bold' }}>混合营养效率图</div>
        <canvas id="MixedTrophicgridCanvas" width="500px" height="500px">MixedTrophic</canvas>
      </div>
  )
}
