...
import { RunEcoSpace_Option,RunEcoSpacae_SelectOption,RunEcoSpacae_PlotMap,RunEcoSpacae_DefaultSelect,EcoSpaceTime } from '../../../store/eweStore';
...
function Map(props){
      ...
      else
      {
        ...
        for (let i = 0; i < gridSize; i++) {
          for (let j = 0; j < gridSize; j++) {
            ...
            // ctx.fillStyle = color;
            ctx.fillRect((550-15*35)/2+j * cellSize, (550-15*35)/2+i * cellSize, cellSize+0.5, cellSize+0.5);
          }
        }
      }
  ...
  return <>
          <div><canvas id="Run_gridCanvas" width="550px" height="550px" style={{border:"1px solid black"}}></canvas></div>
        </>
}
function Maps(){
    ...
    <div style={{display:'flex'}}>
      ...
      <div style={{marginLeft:"150px"}}>
        ...
        <div style={{display:'flex',marginTop:"10px"}}>
          ...
          <div style={{width:"20px",height:"550px",marginLeft:"10px",background:"linear-gradient(to top, #9DFAFF,#64FFAC,#A4FA23,#FCBF02,#FF6602,#FF0000)"}}></div>
        </div>
