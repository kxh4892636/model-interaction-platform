...
def sand2txt(tndPath: str, dstPath: str, dataDict: dict, num: int):
    tinNum = dataDict['num']
    data = dataDict['data']
    tndData: list[str] = []
    # NOTE 二进制读取
...
if __name__ == '__main__':
    ...
    try:
        ...
        # tnd = r"d:\project\001_model_interaction_platform\data\test\sand2txt\snd.dat"
        # csv = r"d:\project\001_model_interaction_platform\data\test\sand2txt\mesh31.csv"
        # dst = r"d:\project\001_model_interaction_platform\data\test\sand2txt"
        # num = "66"
        # timeStamp = '123456'
