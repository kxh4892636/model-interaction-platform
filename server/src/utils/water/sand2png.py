...
if __name__ == '__main__':
    ...
    try:
        ...
        # tnd = r"d:\project\001_model_interaction_platform\data\test\sand2png\snd_123456_0.txt"
        # pngFolder = r"d:\project\001_model_interaction_platform\data\test\sand2png"
        # maskPath = r"d:\project\001_model_interaction_platform\data\test\sand2png\mesh31.shp"
        dirname = os.path.dirname(tnd)
        fileName = os.path.basename(tnd).split('.')[0]
        extent = sand2png(tnd, tnd.replace('txt', 'png'), maskPath)
    except:
