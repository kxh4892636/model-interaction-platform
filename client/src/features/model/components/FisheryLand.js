...
import { FisheryLand,FisheryLandCol,RunModelState,ModifyState } from '../store';
// 可编辑表格
...
const EditableCell = ({
  ...
  const save = async () => {
    try {
      ...
      newModifyData.push({tablename:"ecopathcatch",attribute:'landing',value:parseInt(Object.values(values)[0]),attrgroup:"groupid",groupname:record.name})
...
export default function App() {
    ...
    },[LandColumns.length,ModifyData.length])
