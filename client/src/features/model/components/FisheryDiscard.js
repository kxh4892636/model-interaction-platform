...
import { FisheryDiscard,FisheryDiscardCol } from '../store';
import { DiscardExample } from '../exampledata';
// 可编辑表格
...
export default function App() {
  ...
  return (
    <>
        <Button onClick={()=>{setDiscardData(DiscardExample)}} type="primary" style={{marginBottom: 16}}>Add Example</Button>
        <Table
